...
test("summarizeDashboardState derives metrics from live state without demo offsets", () => {
  const summary = summarizeDashboardState({
    ...
    feedback: [
      feedback({ id: "feedback-high", status: "Open", impact: "High", causeCategories: ["Prompt 问题", "检索问题"] }),
      feedback({ id: "feedback-medium", status: "Open", impact: "Medium", causeCategories: ["Prompt 问题"] }),
