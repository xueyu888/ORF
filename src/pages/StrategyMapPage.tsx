      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_320px]">
        <Card className="overflow-hidden p-5">
          <div>
            ...
            <Connector />
            <StrategyRow nodes={state.results.slice(0, 5).map((result) => ({ type: "结果", title: result.title, status: result.status, progress: result.confidence, owner: result.owner, path: `/objectives/${result.objectiveId}/results/${result.id}` }))} onSelect={setSelected} />
            <Connector />
