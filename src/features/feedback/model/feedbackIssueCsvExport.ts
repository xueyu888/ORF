import { feedbackImpactLabel, feedbackLifecycleLabel, feedbackPriorityLabel } from "../../../utils/labels";
import type { FeedbackIssueListFilters, FeedbackIssueListItem } from "./feedbackIssueList";
