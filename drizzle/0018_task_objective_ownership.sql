...
--> statement-breakpoint
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_linked_result_id_results_id_fk" FOREIGN KEY ("linked_result_id") REFERENCES "public"."results"("id") ON DELETE set null ON UPDATE no action;
--> statement-breakpoint
