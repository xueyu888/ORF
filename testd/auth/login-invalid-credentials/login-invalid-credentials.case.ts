...
function createLoginInvalidCredentialsCase(
  ...
  return {
    ...
    tags: ["auth", "login", roleKey, "validation", "negative"],
    ...
    Setup: {
      description: `准备${roleLabel}测试账号，保证不存在账号场景干净，并进入登录页`,
      steps: [
        step(
          "Setup-1",
          "api",
          "ory.valid_sessions.revoke.setup",
          `撤销邮箱为 \`${data.email}\` 的${roleLabel}登录身份可能残留的登录会话`,
          "ory.sessions",
          "revoke_by_email",
    ...
    S0: {
      description: "登录页可用，目标账号存在，不存在账号场景干净，当前浏览器仍未登录",
      assertions: [
        step("S0-1", "playwright", "url.auth", "当前页面 应为 登录页", "page.url", "match", { pattern: "/auth$" }),
        step("S0-2", "playwright", "heading.sign_in.visible", "登录页中 \"Sign in\" 标题 应可见", "page", "visible", { role: "heading", name: "Sign in" }),
        step("S0-3", "playwright", "input.email.visible", "邮箱输入框 应可见", "page", "visible", { label: "Email" }),
        step("S0-4", "playwright", "input.email.empty", "邮箱输入框的值 应为空", "input", "value", { label: "Email", value: "" }),
        step("S0-5", "playwright", "input.password.visible", "密码输入框 应可见", "page", "visible", { label: "Password", exact: true }),
        step("S0-6", "playwright", "input.password.empty", "密码输入框的值 应为空", "input", "value", { label: "Password", exact: true, value: "" }),
        step("S0-7", "playwright", "button.sign_in.visible", "登录页的 \"Sign In\" 登录操作 应可见", "page", "visible", { role: "button", name: "Sign In" }),
        step("S0-8", "playwright", "button.sign_in.enabled", "登录页的 \"Sign In\" 登录操作 应可点击", "page", "enabled", { role: "button", name: "Sign In" }),
        step("S0-9", "api", "session.unauthenticated", "当前会话 应为 未登录", "auth.session", "unauthenticated"),
        step("S0-10", "playwright", "cookie.absent", "当前浏览器 应不存在 Ory 登录会话 cookie", "browser.cookie", "absent"),
    ...
    Action: {
      description: "逐一提交不满足登录要求的账号或密码",
      steps: [
        step("Action-1", "playwright", "clear.email.empty_account", "清空邮箱输入框", "page", "fill", { label: "Email", value: "" }),
        step("Action-2", "playwright", "fill.password.empty_account", `在密码输入框输入${roleLabel}固定测试密码`, "page", "fill", { label: "Password", exact: true, valueFrom: "data.password" }),
        step("Action-3", "playwright", "click.sign_in.empty_account", "点击 \"Sign In\" 登录操作", "page", "click", { role: "button", name: "Sign In" }),
        step("Action-4", "playwright", "error.email_required.visible", "登录页错误提示 \"请输入邮箱\" 应可见", "page", "visible", { text: "请输入邮箱", exact: true }),
        step("Action-5", "playwright", "fill.email.no_at", `在邮箱输入框输入 \`${data.invalidAccountNoAt}\``, "page", "fill", { label: "Email", valueFrom: "data.invalidAccountNoAt" }),
        step("Action-6", "playwright", "fill.password.no_at", `在密码输入框输入${roleLabel}固定测试密码`, "page", "fill", { label: "Password", exact: true, valueFrom: "data.password" }),
        step("Action-7", "playwright", "click.sign_in.no_at", "点击 \"Sign In\" 登录操作", "page", "click", { role: "button", name: "Sign In" }),
        step("Action-8", "playwright", "error.invalid_email.no_at.visible", "登录页错误提示 \"邮箱格式不正确\" 应可见", "page", "visible", { text: "邮箱格式不正确", exact: true }),
        step("Action-9", "playwright", "fill.email.missing_domain", `在邮箱输入框输入 \`${data.invalidAccountMissingDomain}\``, "page", "fill", { label: "Email", valueFrom: "data.invalidAccountMissingDomain" }),
        step("Action-10", "playwright", "fill.password.missing_domain", `在密码输入框输入${roleLabel}固定测试密码`, "page", "fill", { label: "Password", exact: true, valueFrom: "data.password" }),
        step("Action-11", "playwright", "click.sign_in.missing_domain", "点击 \"Sign In\" 登录操作", "page", "click", { role: "button", name: "Sign In" }),
        step("Action-12", "playwright", "error.invalid_email.missing_domain.visible", "登录页错误提示 \"邮箱格式不正确\" 应可见", "page", "visible", { text: "邮箱格式不正确", exact: true }),
        step("Action-13", "playwright", "fill.email.missing_tld", `在邮箱输入框输入 \`${data.invalidAccountMissingTopLevelDomain}\``, "page", "fill", { label: "Email", valueFrom: "data.invalidAccountMissingTopLevelDomain" }),
        step("Action-14", "playwright", "fill.password.missing_tld", `在密码输入框输入${roleLabel}固定测试密码`, "page", "fill", { label: "Password", exact: true, valueFrom: "data.password" }),
        step("Action-15", "playwright", "click.sign_in.missing_tld", "点击 \"Sign In\" 登录操作", "page", "click", { role: "button", name: "Sign In" }),
        step("Action-16", "playwright", "error.invalid_email.missing_tld.visible", "登录页错误提示 \"邮箱格式不正确\" 应可见", "page", "visible", { text: "邮箱格式不正确", exact: true }),
        step("Action-17", "playwright", "fill.email.with_space", `在邮箱输入框输入 \`${data.invalidAccountWithSpace}\``, "page", "fill", { label: "Email", valueFrom: "data.invalidAccountWithSpace" }),
        step("Action-18", "playwright", "fill.password.with_space", `在密码输入框输入${roleLabel}固定测试密码`, "page", "fill", { label: "Password", exact: true, valueFrom: "data.password" }),
        step("Action-19", "playwright", "click.sign_in.with_space", "点击 \"Sign In\" 登录操作", "page", "click", { role: "button", name: "Sign In" }),
        step("Action-20", "playwright", "error.invalid_email.with_space.visible", "登录页错误提示 \"邮箱格式不正确\" 应可见", "page", "visible", { text: "邮箱格式不正确", exact: true }),
        step("Action-21", "playwright", "fill.email.missing_account", `在邮箱输入框输入 \`${data.nonexistentEmail}\``, "page", "fill", { label: "Email", valueFrom: "data.nonexistentEmail" }),
        step("Action-22", "playwright", "fill.password.missing_account", `在密码输入框输入${roleLabel}固定测试密码`, "page", "fill", { label: "Password", exact: true, valueFrom: "data.password" }),
        step("Action-23", "playwright", "click.sign_in.missing_account", "点击 \"Sign In\" 登录操作", "page.login_form", "submit", { saveAs: "missingAccountLoginResponse" }),
        step("Action-24", "api", "login_response.missing_account.rejected", "登录结果 应被拒绝", "api.response", "rejected", { responseFrom: "runtime.missingAccountLoginResponse", status: 401 }),
        step("Action-25", "playwright", "error.invalid_credentials.missing_account.visible", "登录页错误提示 \"账号或密码不正确\" 应可见", "page", "visible", { text: "账号或密码不正确", exact: true }),
        step("Action-26", "playwright", "fill.email.empty_password", `在邮箱输入框输入 \`${data.email}\``, "page", "fill", { label: "Email", valueFrom: "data.email" }),
        step("Action-27", "playwright", "clear.password.empty_password", "清空密码输入框", "page", "fill", { label: "Password", exact: true, value: "" }),
        step("Action-28", "playwright", "click.sign_in.empty_password", "点击 \"Sign In\" 登录操作", "page", "click", { role: "button", name: "Sign In" }),
        step("Action-29", "playwright", "error.password_required.empty.visible", "登录页错误提示 \"请输入密码\" 应可见", "page", "visible", { text: "请输入密码", exact: true }),
        step("Action-30", "playwright", "fill.email.blank_password", `在邮箱输入框输入 \`${data.email}\``, "page", "fill", { label: "Email", valueFrom: "data.email" }),
        step("Action-31", "playwright", "fill.password.blank_password", "在密码输入框输入纯空白密码", "page", "fill", { label: "Password", exact: true, valueFrom: "data.blankPassword" }),
        step("Action-32", "playwright", "click.sign_in.blank_password", "点击 \"Sign In\" 登录操作", "page", "click", { role: "button", name: "Sign In" }),
        step("Action-33", "playwright", "error.password_required.blank.visible", "登录页错误提示 \"请输入密码\" 应可见", "page", "visible", { text: "请输入密码", exact: true }),
        step("Action-34", "playwright", "fill.email.wrong_password", `在邮箱输入框输入 \`${data.email}\``, "page", "fill", { label: "Email", valueFrom: "data.email" }),
        step("Action-35", "playwright", "fill.password.wrong_password", `在密码输入框输入${roleLabel}错误测试密码`, "page", "fill", { label: "Password", exact: true, valueFrom: "data.wrongPassword" }),
        step("Action-36", "playwright", "click.sign_in.wrong_password", "点击 \"Sign In\" 登录操作", "page.login_form", "submit", { saveAs: "wrongPasswordLoginResponse" }),
        step("Action-37", "api", "login_response.wrong_password.rejected", "登录结果 应被拒绝", "api.response", "rejected", { responseFrom: "runtime.wrongPasswordLoginResponse", status: 401 }),
        step("Action-38", "playwright", "error.invalid_credentials.wrong_password.visible", "登录页错误提示 \"账号或密码不正确\" 应可见", "page", "visible", { text: "账号或密码不正确", exact: true }),
      ],
    },
