...
export const backgroundAdminMemberForbiddenCase = {
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-8", method: "api" }, id: "app_background.config_snapshot", title: "当前系统 `app_background` 配置 应等于 系统背景配置快照中的 `app_background` 配置", object: "api.visual_backgrounds.scene", operator: "config_equals", params: { scene: "app_background", configFrom: "runtime.backgroundSnapshot.app_background.config" } },
    ],
  },
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-3", method: "api" }, id: "app_background_config.forbidden", title: "修改系统 `app_background` 背景配置结果状态码 应为 403 或等价权限错误", object: "api.visual_background_config", operator: "forbidden", params: { resultFrom: "runtime.appBackgroundConfigResult" } },
      ...
      { source: { caseStepId: "S1-5", method: "api" }, id: "app_background.config_snapshot", title: "当前系统 `app_background` 配置 应等于 系统背景配置快照中的 `app_background` 配置", object: "api.visual_backgrounds.scene", operator: "config_equals", params: { scene: "app_background", configFrom: "runtime.backgroundSnapshot.app_background.config" } },
