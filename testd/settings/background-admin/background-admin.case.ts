...
type BackgroundAdminCaseData = BackgroundSettingsCaseData & {
  ...
  topbarBackgroundFileName: string;
};
...
export const backgroundAdminCase = {
  ...
  data: {
    ...
    topbarBackgroundFileName: "testd-admin-topbar-background.png",
  },
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-8", method: "playwright" }, id: "system_config.visible", title: "当前页面 应显示 `System Config`", object: "page", operator: "visible", params: { text: "System Config", exact: true } },
      { source: { caseStepId: "S0-9", method: "playwright" }, id: "login_background_settings.visible", title: "当前页面 应显示 `登录页`", object: "page", operator: "visible", params: { role: "heading", name: "登录页", exact: true } },
      { source: { caseStepId: "S0-10", method: "playwright" }, id: "topbar_background_settings.visible", title: "当前页面 应显示 `顶部栏`", object: "page", operator: "visible", params: { role: "button", name: "顶部栏", exact: true } },
      ...
      { source: { caseStepId: "S0-12", method: "api" }, id: "topbar_background.readable", title: "当前管理员读取系统 顶部栏皮肤列表结果 应成功", object: "api.visual_backgrounds.scene", operator: "readable", params: { scene: "topbar_background" } },
      ...
      { source: { caseStepId: "S0-14", method: "api" }, id: "topbar_background.config_snapshot", title: "当前系统 `topbar_background` 配置 应等于 系统背景配置快照中的 `topbar_background` 配置", object: "api.visual_backgrounds.scene", operator: "config_equals", params: { scene: "topbar_background", configFrom: "runtime.backgroundSnapshot.topbar_background.config" } },
    ],
  },

  Action: {
    description: "管理员上传候选背景，选择并保存为系统登录页和顶部栏默认背景",
    steps: [
      { source: { caseStepId: "Action-1", method: "playwright" }, id: "login_background.upload", title: "在登录页中上传本用例登录页背景图片", object: "page.system_background", operator: "upload_background", params: { scene: "login_background", fileNameFrom: "data.loginBackgroundFileName", saveAs: "uploadedLoginBackground" } },
      { source: { caseStepId: "Action-2", method: "playwright" }, id: "login_background.select", title: "在登录页中选择本用例登录页背景图片", object: "page.system_background", operator: "select_background", params: { scene: "login_background", backgroundFrom: "runtime.uploadedLoginBackground" } },
      { source: { caseStepId: "Action-3", method: "playwright" }, id: "login_background.set_default", title: "在登录页中保存选中图片为系统默认背景", object: "page.system_background", operator: "set_selected_as_default", params: { scene: "login_background", saveAs: "loginBackgroundDefaultResult" } },
      { source: { caseStepId: "Action-4", method: "playwright" }, id: "topbar_background.upload", title: "在顶部栏中上传本用例顶部栏皮肤图片", object: "page.system_background", operator: "upload_background", params: { scene: "topbar_background", fileNameFrom: "data.topbarBackgroundFileName", saveAs: "uploadedTopbarBackground" } },
      { source: { caseStepId: "Action-5", method: "playwright" }, id: "topbar_background.select", title: "在顶部栏中选择本用例顶部栏皮肤图片", object: "page.system_background", operator: "select_background", params: { scene: "topbar_background", backgroundFrom: "runtime.uploadedTopbarBackground" } },
      { source: { caseStepId: "Action-6", method: "playwright" }, id: "topbar_background.set_default", title: "在顶部栏中保存选中图片为系统默认背景", object: "page.system_background", operator: "set_selected_as_default", params: { scene: "topbar_background", saveAs: "topbarBackgroundDefaultResult" } },
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-2", method: "api" }, id: "topbar_background_default.status", title: "顶部栏皮肤设为默认结果状态码 应为 200", object: "api.visual_background_default", operator: "success", params: { resultFrom: "runtime.topbarBackgroundDefaultResult" } },
      ...
      { source: { caseStepId: "S1-4", method: "api" }, id: "topbar_background.contains_uploaded", title: "当前系统顶部栏皮肤列表 应包含 本用例顶部栏皮肤图片", object: "api.visual_backgrounds.scene", operator: "contains_background", params: { scene: "topbar_background", backgroundFrom: "runtime.uploadedTopbarBackground" } },
      ...
      { source: { caseStepId: "S1-6", method: "api" }, id: "topbar_background.fixed_uploaded", title: "重新读取的系统 `topbar_background.fixedBackgroundId` 应为 本用例顶部栏皮肤图片", object: "api.visual_backgrounds.scene", operator: "fixed_background", params: { scene: "topbar_background", backgroundFrom: "runtime.uploadedTopbarBackground" } },
      ...
      { source: { caseStepId: "S1-8", method: "api" }, id: "topbar_background.config_changed", title: "重新读取的系统 `topbar_background` 配置 应不等于 系统背景配置快照中的 `topbar_background` 配置", object: "api.visual_backgrounds.scene", operator: "config_not_snapshot", params: { scene: "topbar_background", snapshotFrom: "runtime.backgroundSnapshot" } },
      { source: { caseStepId: "S1-9", method: "playwright" }, id: "login_background.default_visible", title: "登录页中 应显示 本用例登录页背景图片为 当前背景", object: "page.system_background", operator: "default_visible", params: { scene: "login_background", backgroundFrom: "runtime.uploadedLoginBackground" } },
      { source: { caseStepId: "S1-10", method: "playwright" }, id: "topbar_background.default_visible", title: "顶部栏中 应显示 本用例顶部栏皮肤图片为 当前背景", object: "page.system_background", operator: "default_visible", params: { scene: "topbar_background", backgroundFrom: "runtime.uploadedTopbarBackground" } },
      ...
      { source: { caseStepId: "S1-12", method: "playwright" }, id: "login_background_settings.visible", title: "当前页面 应显示 `登录页` 槽位入口", object: "page", operator: "visible", params: { role: "button", name: "登录页", exact: true } },
      { source: { caseStepId: "S1-13", method: "playwright" }, id: "topbar_background_settings.visible", title: "当前页面 应显示 `顶部栏`", object: "page", operator: "visible", params: { role: "button", name: "顶部栏", exact: true } },
