...
export const backgroundAdminCase = {
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-10", method: "playwright" }, id: "app_background_settings.visible", title: "当前页面 应显示 `应用背景设置`", object: "page", operator: "visible", params: { role: "heading", name: "应用背景设置", exact: true } },
      ...
      { source: { caseStepId: "S0-12", method: "api" }, id: "app_background.readable", title: "当前管理员读取系统登录后页面背景列表结果 应成功", object: "api.visual_backgrounds.scene", operator: "readable", params: { scene: "app_background" } },
  ...
  Action: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Action-4", method: "playwright" }, id: "app_background.upload", title: "在应用背景设置中上传本用例登录后页面背景图片", object: "page.system_background", operator: "upload_background", params: { scene: "app_background", fileNameFrom: "data.appBackgroundFileName", saveAs: "uploadedAppBackground" } },
      { source: { caseStepId: "Action-5", method: "playwright" }, id: "app_background.select", title: "在应用背景设置中选择本用例登录后页面背景图片", object: "page.system_background", operator: "select_background", params: { scene: "app_background", backgroundFrom: "runtime.uploadedAppBackground" } },
      { source: { caseStepId: "Action-6", method: "playwright" }, id: "app_background.set_default", title: "在应用背景设置中将选中图片设为默认背景", object: "page.system_background", operator: "set_selected_as_default", params: { scene: "app_background", saveAs: "appBackgroundDefaultResult" } },
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-2", method: "api" }, id: "app_background_default.status", title: "登录后页面背景设为默认结果状态码 应为 200", object: "api.visual_background_default", operator: "success", params: { resultFrom: "runtime.appBackgroundDefaultResult" } },
      ...
      { source: { caseStepId: "S1-4", method: "api" }, id: "app_background.contains_uploaded", title: "当前系统登录后页面背景列表 应包含 本用例登录后页面背景图片", object: "api.visual_backgrounds.scene", operator: "contains_background", params: { scene: "app_background", backgroundFrom: "runtime.uploadedAppBackground" } },
      ...
      { source: { caseStepId: "S1-6", method: "api" }, id: "app_background.fixed_uploaded", title: "重新读取的系统 `app_background.fixedBackgroundId` 应为 本用例登录后页面背景图片", object: "api.visual_backgrounds.scene", operator: "fixed_background", params: { scene: "app_background", backgroundFrom: "runtime.uploadedAppBackground" } },
      ...
      { source: { caseStepId: "S1-10", method: "playwright" }, id: "app_background.default_visible", title: "应用背景设置中 应显示 本用例登录后页面背景图片为 默认背景", object: "page.system_background", operator: "default_visible", params: { scene: "app_background", backgroundFrom: "runtime.uploadedAppBackground" } },
      ...
      { source: { caseStepId: "S1-13", method: "playwright" }, id: "app_background_settings.visible", title: "当前页面 应显示 `应用背景设置`", object: "page", operator: "visible", params: { role: "heading", name: "应用背景设置", exact: true } },
