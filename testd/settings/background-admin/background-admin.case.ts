...
export const backgroundAdminCase = {
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-8", method: "playwright" }, id: "system_settings_breadcrumb.visible", title: "当前页面 应显示 `系统管理 / 系统设置`", object: "page", operator: "visible", params: { role: "heading", name: "系统管理 / 系统设置", exact: true } },
