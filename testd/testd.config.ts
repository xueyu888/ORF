...
export const testdCases = [
  {
    ...
    traceability: "verified",
    note: "Temporarily disabled by #38 until testd account-menu contract is updated.",
  },
  {
  ...
  },
  {
    ...
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #51 until the full-suite-only publish button visibility failure is isolated by testd.",
  },
  {
  ...
  },
  {
    ...
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #38 until testd fills the required application reason.",
  },
  {
  ...
  },
  {
    ...
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #38 until member subtask creation test flow is revalidated.",
  },
  {
  ...
  },
  {
    ...
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #38 until freeze fixture creates calibrated result points.",
  },
  {
    ...
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #50 until testd result fixtures write required timestamps and calibrated result points.",
  },
  {
  ...
  },
  {
    ...
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #50 until testd result fixtures write required timestamps and align review-loot points with calibrated result scoring.",
  },
  {
    ...
    changePolicy: "locked",
    spec: "testd/acceptance/admin-review-loot-member-forbidden/_entry/admin-review-loot-member-forbidden.spec.ts",
    enabled: false,
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #50 until testd result fixtures write required timestamps and calibrated result points.",
  },
  {
    ...
    doc: "testd-doc/cases/acceptance/管理员验收战利品-非待验收目标不可验收.md",
    changePolicy: "locked",
    spec: "testd/acceptance/admin-review-loot-state-forbidden/_entry/admin-review-loot-state-forbidden.spec.ts",
    enabled: false,
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #50 until testd result fixtures write required timestamps and calibrated result points.",
  ...
  },
  {
    ...
    title: "管理员停用成员",
    doc: "testd-doc/cases/members/管理员停用成员.md",
    changePolicy: "locked",
    spec: "testd/members/admin-disable-member/_entry/admin-disable-member.spec.ts",
    enabled: true,
    fixtureLifecycle: "isolated",
    traceability: "verified",
  },
  {
    ...
    title: "管理员删除成员",
    doc: "testd-doc/cases/members/管理员删除成员.md",
    changePolicy: "locked",
    spec: "testd/members/admin-delete-member/_entry/admin-delete-member.spec.ts",
    enabled: false,
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #52 until the full-suite-only business reference isolation failure is fixed by testd.",
  },
  {
    ...
    changePolicy: "locked",
    spec: "testd/members/admin-edit-member-forbidden/_entry/admin-edit-member-forbidden.spec.ts",
    enabled: true,
    fixtureLifecycle: "isolated",
    traceability: "verified",
  },
  {
    ...
    doc: "testd-doc/cases/members/管理员停用成员-普通成员不可停用成员.md",
    changePolicy: "locked",
    spec: "testd/members/admin-disable-member-forbidden/_entry/admin-disable-member-forbidden.spec.ts",
    enabled: true,
    fixtureLifecycle: "isolated",
    traceability: "verified",
  },
  {
    ...
    doc: "testd-doc/cases/members/管理员删除成员-普通成员不可删除成员.md",
    changePolicy: "locked",
    spec: "testd/members/admin-delete-member-forbidden/_entry/admin-delete-member-forbidden.spec.ts",
    enabled: true,
    fixtureLifecycle: "isolated",
    traceability: "verified",
  },
  {
    ...
    doc: "testd-doc/cases/members/管理员删除成员-被 ORF 业务记录引用成员不可删除.md",
    changePolicy: "locked",
    spec: "testd/members/admin-delete-member-referenced-forbidden/_entry/admin-delete-member-referenced-forbidden.spec.ts",
    enabled: true,
    fixtureLifecycle: "isolated",
    traceability: "verified",
  },
  ...
  },
  {
    ...
    changePolicy: "locked",
    spec: "testd/permissions/member-permission-member-forbidden/_entry/member-permission-forbidden.spec.ts",
    enabled: true,
    fixtureLifecycle: "isolated",
    traceability: "verified",
  },
  ...
  },
  {
    ...
    fixtureLifecycle: "isolated",
    traceability: "verified",
    note: "Temporarily disabled by #38 until testd settings-entry flow follows the account menu.",
  },
  {
