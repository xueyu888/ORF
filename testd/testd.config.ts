...
export const testdCases = [
  ...
  },
  {
    ...
    title: "管理员变更权限-普通成员不可变更权限",
    doc: "testd-doc/cases/auth/管理员变更权限-普通成员不可变更权限.md",
    enabled: false,
    note: "测试代码待实现",
  },
  {
  ...
  {
    id: "permissions.member-admin-update",
    title: "管理员修改成员和管理员权限",
    doc: "testd-doc/cases/permissions/管理员修改成员和管理员权限.md",
    enabled: false,
    note: "测试代码待实现",
  },
  {
    id: "permissions.member-admin-update.member-forbidden",
    title: "管理员修改成员和管理员权限-普通成员不可修改权限",
    doc: "testd-doc/cases/permissions/管理员修改成员和管理员权限-普通成员不可修改权限.md",
    enabled: false,
    note: "测试代码待实现",
  },
  {
