...
export const memberTargetMutationForbiddenAllStagesCase = {
  ...
  Action: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Action-2", method: "playwright" }, id: "member.click_all_edit", title: "普通用户点击 本用例所有阶段目标的 \"编辑\" 操作", object: "page.challenge_objectives", operator: "click_all_edit", params: { targetsFrom: "data.stageTargets" } },
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-7", method: "playwright" }, id: "notice.edit_denied.visible", title: "页面 应提示 `只有指挥官可以编辑目标`", object: "page.challenge_notice", operator: "visible", params: { text: "只有指挥官可以编辑目标" } },
      ...
      { source: { caseStepId: "S1-9", method: "playwright" }, id: "notice.delete_denied.visible", title: "页面 应提示 `没有删除目标权限`", object: "page.challenge_notice", operator: "visible", params: { text: "没有删除目标权限" } },
