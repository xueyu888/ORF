...
export const adminReviewAcceptedSettledEditNoDeleteCase = {
  ...
  Action: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Action-10", method: "playwright" }, id: "delete_submitted.confirm", title: "在删除目标确认框中点击 \"确认删除\" 操作", object: "page.objective_delete_confirm", operator: "confirm" },
      ...
      { source: { caseStepId: "Action-13", method: "playwright" }, id: "delete_accepted.confirm", title: "在删除目标确认框中点击 \"确认删除\" 操作", object: "page.objective_delete_confirm", operator: "confirm" },
      ...
      { source: { caseStepId: "Action-16", method: "playwright" }, id: "delete_settled.confirm", title: "在删除目标确认框中点击 \"确认删除\" 操作", object: "page.objective_delete_confirm", operator: "confirm" },
