...
export const memberReestimateCompleteRequestCase = {
  ...
  title: "参与的普通成员可在重估中阶段维护目标估算并申请完成重估",
  ...
  Action: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Action-3", method: "playwright" }, id: "metric.title.fill", title: "在新增指标标题输入框输入 `E2E-METRIC-MEMBER-REESTIMATE-COMPLETE`", object: "page.metric_title_editor", operator: "fill", params: { titleFrom: "data.metricTitle" } },
      { source: { caseStepId: "Action-4", method: "playwright" }, id: "metric.title.submit", title: "提交 新增指标标题", object: "page.metric_title_editor", operator: "submit", params: { titleFrom: "data.metricTitle", saveAs: "metric" } },
      { source: { caseStepId: "Action-5", method: "playwright" }, id: "metric.difficulty.select", title: "将指标 `E2E-METRIC-MEMBER-REESTIMATE-COMPLETE` 的难度等级选择为 `进阶`", object: "page.metric_difficulty", operator: "select", params: { metricTitleFrom: "data.metricTitle", difficultyFrom: "data.metricDifficulty" } },
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-6", method: "playwright" }, id: "metric.visible", title: "目标 `E2E-TARGET-MEMBER-REESTIMATE-COMPLETE` 下 应显示指标 `E2E-METRIC-MEMBER-REESTIMATE-COMPLETE`", object: "page.challenge_metric", operator: "visible_under_objective", params: { targetTitleFrom: "data.target.title", metricTitleFrom: "data.metricTitle" } },
      { source: { caseStepId: "S1-7", method: "playwright" }, id: "metric.difficulty.visible", title: "指标 `E2E-METRIC-MEMBER-REESTIMATE-COMPLETE` 的难度等级 应显示为 `进阶`", object: "page.metric_difficulty", operator: "visible", params: { metricTitleFrom: "data.metricTitle", difficultyFrom: "data.metricDifficulty" } },
      ...
      { source: { caseStepId: "S1-12", method: "prisma" }, id: "db.metric.exists", title: "应存在 归属于目标 `E2E-TARGET-MEMBER-REESTIMATE-COMPLETE`、标题为 `E2E-METRIC-MEMBER-REESTIMATE-COMPLETE`、难度等级为 `进阶` 的指标", object: "db.metric", operator: "exists_with_difficulty", params: { targetFrom: "data.target", titleFrom: "data.metricTitle", difficultyFrom: "data.metricDifficulty" } },
