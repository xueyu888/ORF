...
export const memberLeaveCategorySubmitWorkLogCase = {
  ...
  Action: {
    description: "成员选择请假分类，填写记录时间和正文并提交当天日志",
    steps: [
      ...
      { source: { caseStepId: "Action-4", method: "playwright" }, id: "work_logs.fill_duration", title: "在 \"记录时间分钟数\" 输入框输入 `480`", object: "page.work_logs.duration_input", operator: "fill", params: { valueFrom: "data.durationMinutes" } },
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-4", method: "playwright" }, id: "work_logs.history.duration", title: "\"当天记录\" 区域 应显示记录时间 `8h`", object: "page.work_logs.history", operator: "contains_duration", params: { bodyMarkerFrom: "data.logBodyMarker", durationLabelFrom: "data.expectedDurationLabel" } },
      ...
      { source: { caseStepId: "S1-11", method: "api" }, id: "work_log.my_day.duration", title: "当天工作日志数据中的本用例工作日志记录时间分钟数 应为 `480`", object: "api.work_log.my_day", operator: "duration_minutes", params: { bodyMarkerFrom: "data.logBodyMarker", valueFrom: "data.durationMinutes" } },
      ...
      { source: { caseStepId: "S1-18", method: "prisma" }, id: "db.work_log.duration", title: "本用例工作日志的记录时间分钟数 应为 `480`", object: "db.work_log_entry.duration_minutes", operator: "equals", params: { entryFrom: "runtime.submittedWorkLogEntry", valueFrom: "data.durationMinutes" } },
