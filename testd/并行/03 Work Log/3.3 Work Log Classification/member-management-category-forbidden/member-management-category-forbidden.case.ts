...
export const memberManagementCategoryForbiddenCase = {
  ...
  data: {
    ...
    memberRole: "member",
    memberStatus: "active",
    teamId: "team-testd-member-management-category-forbidden",
    teamName: "TestD Member Management Category Forbidden Team",
  ...
  Setup: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Setup-6", method: "prisma" }, id: "db.work_log_category.upsert_management", title: "准备 名称为 `管理事务`、属于本用例成员团队、由本用例管理员创建的工作日志管理分类", object: "db.work_log_category", operator: "upsert_management", params: { categoryName: "管理事务", teamIdFrom: "data.teamId", teamNameFrom: "data.teamName", createdByUserIdFrom: "runtime.adminUser.userId", memberUserIdFrom: "runtime.memberUser.userId", saveAs: "managementCategory" } },
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-6", method: "prisma" }, id: "db.work_log_category.exists", title: "应存在 名称为 `管理事务`、属于本用例成员团队的工作日志管理分类", object: "db.work_log_category", operator: "exists_in_team", params: { categoryName: "管理事务", teamIdFrom: "data.teamId" } },
