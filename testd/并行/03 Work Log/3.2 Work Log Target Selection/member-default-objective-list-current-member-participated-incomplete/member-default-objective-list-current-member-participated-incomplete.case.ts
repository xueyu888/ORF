...
import type { MemberDefaultObjectiveListCurrentMemberParticipatedIncompleteCaseData } from "./_support/member-default-objective-list-current-member-participated-incomplete.context";

export const memberDefaultObjectiveListCurrentMemberParticipatedIncompleteCase = {
  id: "work-log.member-default-objective-list-current-member-participated-incomplete",
  title: "普通成员默认目标列表仅展示当前成员参与且未完成的目标",
  ...
  Setup: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Setup-4", method: "prisma" }, id: "db.other_member_user.upsert", title: "准备 角色为 `member`、状态为 `active`、名称为 `ORF Other Work Log Default Objective List E2E`、与本用例成员属于同一团队的本用例其他成员用户", object: "db.user", operator: "upsert", params: { emailFrom: "data.otherMemberEmail", nameFrom: "data.otherMemberName", roleFrom: "data.otherMemberRole", statusFrom: "data.otherMemberStatus", teamIdFrom: "runtime.memberUser.teamId", saveAs: "otherMemberUser" } },
      { source: { caseStepId: "Setup-5", method: "prisma" }, id: "db.participated_open_objective.prepare", title: "准备 标题为 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-PARTICIPATED-OPEN`、属于本用例成员团队、当前挑战者包含本用例成员、流转状态为 `open` 的未完成目标", object: "db.objective", operator: "upsert", params: { titleFrom: "data.participatedOpenObjectiveTitle", teamIdFrom: "runtime.memberUser.teamId", challengersFrom: "data.memberName", challengerUserIdsFrom: "runtime.memberUser.userId", flowStatusFrom: "data.openFlowStatus", stageFrom: "data.objectiveStage", statusFrom: "data.objectiveStatus", createdByFrom: "runtime.memberUser.userId", updatedByFrom: "runtime.memberUser.userId", saveAs: "participatedOpenObjective" } },
      { source: { caseStepId: "Setup-6", method: "prisma" }, id: "db.other_open_objective.prepare", title: "准备 标题为 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-OTHER-OPEN`、属于本用例成员团队、当前挑战者包含本用例其他成员且不包含本用例成员、流转状态为 `open` 的未完成目标", object: "db.objective", operator: "upsert", params: { titleFrom: "data.otherOpenObjectiveTitle", teamIdFrom: "runtime.memberUser.teamId", challengersFrom: "data.otherMemberName", challengerUserIdsFrom: "runtime.otherMemberUser.userId", flowStatusFrom: "data.openFlowStatus", stageFrom: "data.objectiveStage", statusFrom: "data.objectiveStatus", createdByFrom: "runtime.memberUser.userId", updatedByFrom: "runtime.memberUser.userId", saveAs: "otherOpenObjective" } },
      { source: { caseStepId: "Setup-7", method: "prisma" }, id: "db.participated_accepted_objective.prepare", title: "准备 标题为 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-PARTICIPATED-ACCEPTED`、属于本用例成员团队、当前挑战者包含本用例成员、流转状态为 `accepted` 的已完成目标", object: "db.objective", operator: "upsert", params: { titleFrom: "data.participatedAcceptedObjectiveTitle", teamIdFrom: "runtime.memberUser.teamId", challengersFrom: "data.memberName", challengerUserIdsFrom: "runtime.memberUser.userId", flowStatusFrom: "data.acceptedFlowStatus", stageFrom: "data.objectiveStage", statusFrom: "data.objectiveStatus", createdByFrom: "runtime.memberUser.userId", updatedByFrom: "runtime.memberUser.userId", saveAs: "participatedAcceptedObjective" } },
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-5", method: "prisma" }, id: "db.participated_open_objective.exists", title: "应存在 标题为 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-PARTICIPATED-OPEN`、属于本用例成员团队、当前挑战者包含本用例成员、流转状态为 `open` 的目标", object: "db.work_log_objective_fixture", operator: "exists", params: { titleFrom: "data.participatedOpenObjectiveTitle", flowStatusFrom: "data.openFlowStatus", challengerUserIdFrom: "runtime.memberUser.userId" } },
      { source: { caseStepId: "S0-6", method: "prisma" }, id: "db.other_open_objective.exists", title: "应存在 标题为 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-OTHER-OPEN`、属于本用例成员团队、当前挑战者不包含本用例成员、流转状态为 `open` 的目标", object: "db.work_log_objective_fixture", operator: "exists", params: { titleFrom: "data.otherOpenObjectiveTitle", flowStatusFrom: "data.openFlowStatus", challengerUserIdFrom: "runtime.otherMemberUser.userId", excludedChallengerUserIdFrom: "runtime.memberUser.userId" } },
      { source: { caseStepId: "S0-7", method: "prisma" }, id: "db.participated_accepted_objective.exists", title: "应存在 标题为 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-PARTICIPATED-ACCEPTED`、属于本用例成员团队、当前挑战者包含本用例成员、流转状态为 `accepted` 的目标", object: "db.work_log_objective_fixture", operator: "exists", params: { titleFrom: "data.participatedAcceptedObjectiveTitle", flowStatusFrom: "data.acceptedFlowStatus", challengerUserIdFrom: "runtime.memberUser.userId" } },
      { source: { caseStepId: "S0-8", method: "api" }, id: "work_log.default_objectives.contains_participated_open", title: "工作日志默认目标列表 应包含目标 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-PARTICIPATED-OPEN`", object: "api.work_log.default_objectives", operator: "contains_title", params: { titleFrom: "data.participatedOpenObjectiveTitle" } },
      { source: { caseStepId: "S0-9", method: "api" }, id: "work_log.default_objectives.excludes_other_open", title: "工作日志默认目标列表 应不包含目标 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-OTHER-OPEN`", object: "api.work_log.default_objectives", operator: "not_contains_title", params: { titleFrom: "data.otherOpenObjectiveTitle" } },
      { source: { caseStepId: "S0-10", method: "api" }, id: "work_log.default_objectives.excludes_participated_accepted", title: "工作日志默认目标列表 应不包含目标 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-PARTICIPATED-ACCEPTED`", object: "api.work_log.default_objectives", operator: "not_contains_title", params: { titleFrom: "data.participatedAcceptedObjectiveTitle" } },
      { source: { caseStepId: "S0-11", method: "api" }, id: "work_log.default_objectives.current_challenger", title: "工作日志默认目标列表中的目标 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-PARTICIPATED-OPEN` 对当前成员 应为 当前挑战者", object: "api.work_log.default_objectives", operator: "current_challenger", params: { titleFrom: "data.participatedOpenObjectiveTitle" } },
      { source: { caseStepId: "S0-12", method: "api" }, id: "work_log.default_objectives.flow_status_open", title: "工作日志默认目标列表中的目标 `E2E-TARGET-WORK-LOG-DEFAULT-LIST-PARTICIPATED-OPEN` 流转状态 应为 `open`", object: "api.work_log.default_objectives", operator: "flow_status", params: { titleFrom: "data.participatedOpenObjectiveTitle", flowStatusFrom: "data.openFlowStatus" } },
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-5", method: "playwright" }, id: "work_logs.page.error_absent", title: "页面 应不显示 错误提示", object: "page.work_logs", operator: "error_absent" },
    ],
  },
...
} satisfies StateCaseSpec<MemberDefaultObjectiveListCurrentMemberParticipatedIncompleteCaseData>;
