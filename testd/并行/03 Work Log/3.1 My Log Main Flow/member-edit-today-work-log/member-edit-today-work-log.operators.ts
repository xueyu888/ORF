...
import type {
  MemberEditTodayWorkLogCaseData,
  TestContext,
  WorkLogEntryFixture,
...
import {
  ...
  workLogToast,
  workLogViewTab,
} from "./_support/member-edit-today-work-log.helpers";

export const memberEditTodayWorkLogOperators: OperatorRegistry<TestContext, MemberEditTodayWorkLogCaseData> = {
  "page.auth": {
