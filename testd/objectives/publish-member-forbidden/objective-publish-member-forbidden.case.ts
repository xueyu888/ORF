...
export const objectivePublishMemberForbiddenCase = {
  ...
  Setup: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Setup-9", method: "playwright" }, id: "fill.email", title: "在邮箱输入框输入本次运行独占普通成员邮箱", object: "page", operator: "fill", params: { label: "Email", valueFrom: "data.email" } },
      ...
      { source: { caseStepId: "Setup-13", method: "api" }, id: "session.email", title: "当前会话用户邮箱 应为 本次运行独占普通成员邮箱", object: "auth.session.user_email", operator: "equals", params: { emailFrom: "data.email" } },
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-6", method: "prisma" }, id: "db.objective.absent", title: "应不存在 本次运行独占测试目标标题对应的测试目标", object: "db.objective", operator: "absent", params: { titleFrom: "data.objectiveTitle" } },
    ],
  },
  ...
  Clean: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Clean-7", method: "api" }, id: "ory.member_identity.delete", title: "删除本次运行独占普通成员登录身份", object: "ory.identity", operator: "delete_by_email", params: { emailFrom: "data.email" } },
      { source: { caseStepId: "Clean-8", method: "prisma" }, id: "db.member.memberships.delete", title: "删除本次运行独占普通成员用户默认团队成员关系", object: "db.user", operator: "delete_memberships", params: { emailFrom: "data.email" } },
      { source: { caseStepId: "Clean-9", method: "prisma" }, id: "db.member.delete", title: "删除本次运行独占普通成员用户", object: "db.user", operator: "delete", params: { emailFrom: "data.email" } },
      { source: { caseStepId: "Clean-10", method: "prisma" }, id: "db.objective.absent", title: "应不存在 本次运行独占测试目标标题对应的测试目标", object: "db.objective", operator: "absent", params: { titleFrom: "data.objectiveTitle" } },
      { source: { caseStepId: "Clean-11", method: "api" }, id: "ory.member_identity.absent", title: "本次运行独占普通成员登录身份 应不存在", object: "ory.identity", operator: "absent", params: { emailFrom: "data.email" } },
      { source: { caseStepId: "Clean-12", method: "prisma" }, id: "db.member.absent", title: "本次运行独占普通成员用户 应不存在", object: "db.user", operator: "absent", params: { emailFrom: "data.email" } },
    ],
  },
