...
export const memberSubmitPeerReviewStateForbiddenCase = {
  ...
  Setup: {
    description: "准备普通成员、四个非待验收状态目标和已结算目标前置战利品，并以普通成员身份完成登录",
    steps: [
      { source: { caseStepId: "Setup-1", method: "prisma" }, id: "db.state_peer_review.delete_residue", title: "删除 本用例残留的非待验收状态匿名互评记录", object: "db.state_peer_review", operator: "delete_residue" },
      { source: { caseStepId: "Setup-2", method: "prisma" }, id: "db.state_peer_review_loot.delete_residue", title: "删除 本用例残留的非待验收状态前置战利品", object: "db.state_peer_review_loot", operator: "delete_residue" },
      { source: { caseStepId: "Setup-3", method: "prisma" }, id: "db.state_peer_review_target.delete_residue", title: "删除 本用例残留的非待验收状态互评目标及其派生数据", object: "db.state_peer_review_target", operator: "delete_residue" },
      ...
      { source: { caseStepId: "Setup-9", method: "prisma" }, id: "db.settled_peer_review_target.upsert", title: "创建标题为 `E2E-PEER-REVIEW-STATE-FORBIDDEN: 已结算目标`、流转状态为 `settled`、阶段为 `goalFrozen` 的本用例已结算互评目标", object: "db.state_peer_review_target", operator: "upsert", params: { fixtureFrom: "data.targets.settled", teamIdFrom: "runtime.memberUser.teamId", createdByFrom: "runtime.memberUser.userId", updatedByFrom: "runtime.memberUser.userId", saveAs: "settledTarget" } },
      { source: { caseStepId: "Setup-10", method: "prisma" }, id: "db.settled_peer_review_loot.create", title: "为本用例已结算互评目标创建内容为 `E2E-PEER-REVIEW-STATE-FORBIDDEN-LOOT: 已结算前置战利品` 的前置战利品", object: "db.state_peer_review_loot", operator: "create", params: { targetFrom: "runtime.settledTarget", lootFrom: "data.loot.settled", saveAs: "settledLoot" } },
      ...
      { source: { caseStepId: "Setup-14", method: "playwright" }, id: "fill.member_email", title: "在邮箱输入框输入普通成员固定测试邮箱", object: "page", operator: "fill", params: { label: "Email", valueFrom: "data.email" } },
      { source: { caseStepId: "Setup-15", method: "playwright" }, id: "fill.member_password", title: "在密码输入框输入普通成员固定测试密码", object: "page", operator: "fill", params: { label: "Password", exact: true, valueFrom: "data.password" } },
      { source: { caseStepId: "Setup-16", method: "playwright" }, id: "click.member_sign_in", title: "点击 \"Sign In\" 登录操作", object: "page.state_peer_review_login", operator: "submit_member" },
    ],
  },

  S0: {
    description: "普通成员已登录，四个非待验收状态目标均包含该普通成员为挑战者",
    assertions: [
      ...
      { source: { caseStepId: "S0-2", method: "prisma" }, id: "state_targets.states", title: "四个本用例非待验收状态互评目标 应为 各自预设的流转状态、阶段、战利品提交时间和挑战者列表", object: "db.state_peer_review_target", operator: "states" },
      { source: { caseStepId: "S0-3", method: "prisma" }, id: "settled_loot.present", title: "本用例已结算互评目标 应存在 前置战利品", object: "db.state_peer_review_loot", operator: "all_present" },
      { source: { caseStepId: "S0-4", method: "prisma" }, id: "state_peer_review.absent", title: "四个本用例非待验收状态互评目标 应不存在 普通成员提交的匿名互评", object: "db.state_peer_review", operator: "absent" },
    ],
  },
  ...
  S1: {
    description: "四个非待验收状态目标可见，但提交匿名互评入口不可见，数据库不新增匿名互评",
    assertions: [
      ...
      { source: { caseStepId: "S1-3", method: "playwright" }, id: "state_targets.visible", title: "四个本用例非待验收状态互评目标面板 应均可见", object: "page.state_peer_review_targets", operator: "visible" },
      { source: { caseStepId: "S1-4", method: "playwright" }, id: "state_targets.submit_action_absent", title: "四个本用例非待验收状态互评目标的 \"提交匿名互评\" 入口 应均不可见", object: "page.state_peer_review_targets", operator: "submit_action_absent" },
      { source: { caseStepId: "S1-5", method: "api" }, id: "member_workbench.targets_present", title: "普通成员挑战工作台数据 应包含 四个本用例非待验收状态互评目标", object: "api.state_peer_review_member_workbench", operator: "targets_present" },
      { source: { caseStepId: "S1-6", method: "prisma" }, id: "state_targets.states_unchanged", title: "四个本用例非待验收状态互评目标的流转状态、阶段、战利品提交时间和挑战者列表 应保持不变", object: "db.state_peer_review_target", operator: "states" },
      { source: { caseStepId: "S1-7", method: "prisma" }, id: "settled_loot.still_present", title: "本用例已结算互评目标 应仍存在 前置战利品", object: "db.state_peer_review_loot", operator: "all_present" },
      { source: { caseStepId: "S1-8", method: "prisma" }, id: "state_peer_review.still_absent", title: "四个本用例非待验收状态互评目标 应仍不存在 普通成员提交的匿名互评", object: "db.state_peer_review", operator: "absent" },
  ...
  Clean: {
    description: "删除非待验收状态互评目标、前置战利品、测试用户和浏览器运行态",
    steps: [
      { source: { caseStepId: "Clean-1", method: "prisma" }, id: "db.state_peer_review.delete", title: "删除 本用例残留的非待验收状态匿名互评记录", object: "db.state_peer_review", operator: "delete_residue" },
      { source: { caseStepId: "Clean-2", method: "prisma" }, id: "db.state_peer_review_loot.delete", title: "删除 本用例非待验收状态前置战利品", object: "db.state_peer_review_loot", operator: "delete_residue" },
      { source: { caseStepId: "Clean-3", method: "prisma" }, id: "db.state_peer_review_target.delete", title: "删除 本用例非待验收状态互评目标及其派生数据", object: "db.state_peer_review_target", operator: "delete_residue" },
      ...
      { source: { caseStepId: "Clean-11", method: "prisma" }, id: "db.state_peer_review.absent", title: "应不存在 本用例非待验收状态匿名互评记录", object: "db.state_peer_review", operator: "absent" },
      { source: { caseStepId: "Clean-12", method: "prisma" }, id: "db.state_peer_review_loot.absent", title: "应不存在 本用例非待验收状态前置战利品", object: "db.state_peer_review_loot", operator: "absent" },
      { source: { caseStepId: "Clean-13", method: "prisma" }, id: "db.state_peer_review_target.absent", title: "应不存在 本用例非待验收状态互评目标", object: "db.state_peer_review_target", operator: "absent" },
