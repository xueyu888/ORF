...
export const adminReviewLootStateForbiddenCase = {
  ...
  data: {
    ...
    targets: {
      ...
      accepted: {
        id: "obj-testd-review-loot-state-forbidden-accepted",
        title: "E2E-REVIEW-LOOT-STATE-FORBIDDEN: 已验收目标",
        stage: "goalFrozen",
        flowStatus: "accepted",
    ...
    result: {
      accepted: {
        title: "E2E-REVIEW-LOOT-STATE-FORBIDDEN: 已验收前置指标",
        metricName: "E2E 管理员不可重复验收已验收目标指标完成率",
        points: 30,
      },
      settled: {
        title: "E2E-REVIEW-LOOT-STATE-FORBIDDEN: 已结算前置指标",
        metricName: "E2E 管理员不可验收已结算目标指标完成率",
        points: 30,
      },
    },
    loot: {
      accepted: {
        body: "E2E-REVIEW-LOOT-STATE-FORBIDDEN-BODY: 已验收前置战利品",
        submittedBy: "ORF Review Loot State Challenger E2E",
        evidenceText: "E2E-REVIEW-LOOT-STATE-FORBIDDEN-EVIDENCE: 已验收完成证据",
      },
      settled: {
  ...
  Setup: {
    description: "准备管理员、五个非待验收目标及已验收和已结算目标前置数据，并以管理员身份完成登录",
    steps: [
      ...
      { source: { caseStepId: "Setup-2", method: "prisma" }, id: "db.state_review_loot.delete_residue", title: "删除本用例残留的已验收和已结算前置战利品", object: "db.state_review_loot", operator: "delete_residue" },
      { source: { caseStepId: "Setup-3", method: "prisma" }, id: "db.state_review_loot_result.delete_residue", title: "删除本用例残留的已验收和已结算前置指标", object: "db.state_review_loot_result", operator: "delete_residue" },
      { source: { caseStepId: "Setup-4", method: "prisma" }, id: "db.state_review_loot_target.delete_residue", title: "删除本用例残留的五个非待验收目标及其派生数据", object: "db.state_review_loot_target", operator: "delete_residue" },
      ...
      { source: { caseStepId: "Setup-10", method: "prisma" }, id: "db.accepted_review_loot_target.upsert", title: "创建标题为 `E2E-REVIEW-LOOT-STATE-FORBIDDEN: 已验收目标`、流转状态为 `accepted`、阶段为 `goalFrozen` 的本用例已验收目标", object: "db.state_review_loot_target", operator: "upsert", params: { fixtureFrom: "data.targets.accepted", teamIdFrom: "runtime.adminUser.teamId", createdByFrom: "runtime.adminUser.userId", updatedByFrom: "runtime.adminUser.userId", saveAs: "acceptedTarget" } },
      { source: { caseStepId: "Setup-11", method: "prisma" }, id: "db.settled_review_loot_target.upsert", title: "创建标题为 `E2E-REVIEW-LOOT-STATE-FORBIDDEN: 已结算目标`、流转状态为 `settled`、阶段为 `goalFrozen` 的本用例已结算目标", object: "db.state_review_loot_target", operator: "upsert", params: { fixtureFrom: "data.targets.settled", teamIdFrom: "runtime.adminUser.teamId", createdByFrom: "runtime.adminUser.userId", updatedByFrom: "runtime.adminUser.userId", saveAs: "settledTarget" } },
      { source: { caseStepId: "Setup-12", method: "prisma" }, id: "db.accepted_review_loot_result.create", title: "为本用例已验收目标创建标题为 `E2E-REVIEW-LOOT-STATE-FORBIDDEN: 已验收前置指标`、指标积分为 `30` 的前置指标", object: "db.state_review_loot_result", operator: "create", params: { targetFrom: "runtime.acceptedTarget", resultFrom: "data.result.accepted", saveAs: "acceptedResult" } },
      { source: { caseStepId: "Setup-13", method: "prisma" }, id: "db.accepted_review_loot.create", title: "为本用例已验收目标创建内容为 `E2E-REVIEW-LOOT-STATE-FORBIDDEN-BODY: 已验收前置战利品` 的前置战利品", object: "db.state_review_loot", operator: "create", params: { targetFrom: "runtime.acceptedTarget", resultFrom: "runtime.acceptedResult", lootFrom: "data.loot.accepted", saveAs: "acceptedLoot" } },
      { source: { caseStepId: "Setup-14", method: "prisma" }, id: "db.settled_review_loot_result.create", title: "为本用例已结算目标创建标题为 `E2E-REVIEW-LOOT-STATE-FORBIDDEN: 已结算前置指标`、指标积分为 `30` 的前置指标", object: "db.state_review_loot_result", operator: "create", params: { targetFrom: "runtime.settledTarget", resultFrom: "data.result.settled", saveAs: "settledResult" } },
      { source: { caseStepId: "Setup-15", method: "prisma" }, id: "db.settled_review_loot.create", title: "为本用例已结算目标创建内容为 `E2E-REVIEW-LOOT-STATE-FORBIDDEN-BODY: 已结算前置战利品` 的前置战利品", object: "db.state_review_loot", operator: "create", params: { targetFrom: "runtime.settledTarget", resultFrom: "runtime.settledResult", lootFrom: "data.loot.settled", saveAs: "settledLoot" } },
      { source: { caseStepId: "Setup-16", method: "api" }, id: "ory.admin_sessions.revoke", title: "撤销管理员认证身份的残留登录会话", object: "ory.sessions", operator: "revoke_by_email", params: { emailFrom: "data.email" } },
      ...
      { source: { caseStepId: "Setup-19", method: "playwright" }, id: "fill.admin_email", title: "在邮箱输入框输入管理员固定测试邮箱", object: "page", operator: "fill", params: { label: "Email", valueFrom: "data.email" } },
      { source: { caseStepId: "Setup-20", method: "playwright" }, id: "fill.admin_password", title: "在密码输入框输入管理员固定测试密码", object: "page", operator: "fill", params: { label: "Password", exact: true, valueFrom: "data.password" } },
      { source: { caseStepId: "Setup-21", method: "playwright" }, id: "click.admin_sign_in", title: "点击 \"Sign In\" 登录操作", object: "page.state_review_loot_login", operator: "submit_admin" },
    ],
  },

  S0: {
    description: "管理员已登录，五个本用例目标均处于非待验收状态",
    assertions: [
      ...
      { source: { caseStepId: "S0-2", method: "prisma" }, id: "state_review_loot_targets.states", title: "五个本用例非待验收目标 应为 各自预设的流转状态、阶段、战利品提交时间和挑战者列表", object: "db.state_review_loot_target", operator: "states" },
      { source: { caseStepId: "S0-3", method: "prisma" }, id: "accepted_review_loot_result.present", title: "本用例已验收目标 应存在 指标积分为 `30` 的前置指标", object: "db.state_review_loot_result", operator: "present", params: { targetFrom: "runtime.acceptedTarget", resultFrom: "runtime.acceptedResult" } },
      { source: { caseStepId: "S0-4", method: "prisma" }, id: "accepted_review_loot.present", title: "本用例已验收目标 应存在 前置战利品", object: "db.state_review_loot", operator: "present", params: { targetFrom: "runtime.acceptedTarget", resultFrom: "runtime.acceptedResult", lootFrom: "runtime.acceptedLoot" } },
      { source: { caseStepId: "S0-5", method: "prisma" }, id: "settled_review_loot_result.present", title: "本用例已结算目标 应存在 指标积分为 `30` 的前置指标", object: "db.state_review_loot_result", operator: "present", params: { targetFrom: "runtime.settledTarget", resultFrom: "runtime.settledResult" } },
      { source: { caseStepId: "S0-6", method: "prisma" }, id: "settled_review_loot.present", title: "本用例已结算目标 应存在 前置战利品", object: "db.state_review_loot", operator: "present", params: { targetFrom: "runtime.settledTarget", resultFrom: "runtime.settledResult", lootFrom: "runtime.settledLoot" } },
      { source: { caseStepId: "S0-7", method: "prisma" }, id: "state_review_loot_ledger.absent", title: "reason 为 `E2E-REVIEW-LOOT-STATE-FORBIDDEN: 非待验收目标不可验收` 的测试积分流水 应不存在", object: "db.state_review_loot_ledger", operator: "absent" },
    ],
  },
  ...
  S1: {
    description: "五个非待验收目标可见，但验收战利品入口不可见，数据库验收状态不变化",
    assertions: [
      ...
      { source: { caseStepId: "S1-3", method: "playwright" }, id: "state_review_loot_targets.visible", title: "五个本用例非待验收目标面板 应均可见", object: "page.state_review_loot_targets", operator: "visible" },
      { source: { caseStepId: "S1-4", method: "playwright" }, id: "state_review_loot_targets.review_action_absent", title: "五个本用例非待验收目标的 \"验收战利品\" 入口 应均不可见", object: "page.state_review_loot_targets", operator: "review_action_absent" },
      { source: { caseStepId: "S1-5", method: "api" }, id: "admin_workbench.targets_present", title: "管理员所有挑战工作台数据 应包含 五个本用例非待验收目标", object: "api.state_review_loot_workbench", operator: "targets_present" },
      { source: { caseStepId: "S1-6", method: "prisma" }, id: "state_review_loot_targets.states_unchanged", title: "五个本用例非待验收目标的流转状态、阶段、战利品提交时间和挑战者列表 应保持不变", object: "db.state_review_loot_target", operator: "states" },
      { source: { caseStepId: "S1-7", method: "prisma" }, id: "accepted_review_loot.still_present", title: "本用例已验收目标 应仍存在 前置战利品", object: "db.state_review_loot", operator: "present", params: { targetFrom: "runtime.acceptedTarget", resultFrom: "runtime.acceptedResult", lootFrom: "runtime.acceptedLoot" } },
      { source: { caseStepId: "S1-8", method: "prisma" }, id: "settled_review_loot.still_present", title: "本用例已结算目标 应仍存在 前置战利品", object: "db.state_review_loot", operator: "present", params: { targetFrom: "runtime.settledTarget", resultFrom: "runtime.settledResult", lootFrom: "runtime.settledLoot" } },
      { source: { caseStepId: "S1-9", method: "prisma" }, id: "state_review_loot_ledger.still_absent", title: "reason 为 `E2E-REVIEW-LOOT-STATE-FORBIDDEN: 非待验收目标不可验收` 的测试积分流水 应仍不存在", object: "db.state_review_loot_ledger", operator: "absent" },
      { source: { caseStepId: "S1-10", method: "api" }, id: "session.admin.still_authenticated", title: "当前会话 应仍为 邮箱 `orf-admin-review-loot-state-forbidden-e2e@orf.local`、角色为 `admin`、状态为 `active` 的已登录会话", object: "auth.session", operator: "authenticated", params: { emailFrom: "data.email", roleFrom: "data.role", status: "active" } },
    ],
  },

  Clean: {
    description: "删除五个非待验收目标、前置指标、前置战利品、测试用户和浏览器运行态",
    steps: [
      ...
      { source: { caseStepId: "Clean-2", method: "prisma" }, id: "db.state_review_loot.delete", title: "删除本用例已验收和已结算前置战利品", object: "db.state_review_loot", operator: "delete_residue" },
      { source: { caseStepId: "Clean-3", method: "prisma" }, id: "db.state_review_loot_result.delete", title: "删除本用例已验收和已结算前置指标", object: "db.state_review_loot_result", operator: "delete_residue" },
      { source: { caseStepId: "Clean-4", method: "prisma" }, id: "db.state_review_loot_target.delete", title: "删除本用例五个非待验收目标及其派生数据", object: "db.state_review_loot_target", operator: "delete_residue" },
      ...
      { source: { caseStepId: "Clean-13", method: "prisma" }, id: "db.state_review_loot.absent", title: "本用例已验收和已结算前置战利品 应不存在", object: "db.state_review_loot", operator: "absent" },
      { source: { caseStepId: "Clean-14", method: "prisma" }, id: "db.state_review_loot_result.absent", title: "本用例已验收和已结算前置指标 应不存在", object: "db.state_review_loot_result", operator: "absent" },
      { source: { caseStepId: "Clean-15", method: "prisma" }, id: "db.state_review_loot_target.absent", title: "本用例五个非待验收目标 应不存在", object: "db.state_review_loot_target", operator: "absent" },
