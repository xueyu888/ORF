...
export const adminReviewLootCase = {
  ...
  Setup: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Setup-10", method: "prisma" }, id: "db.review_loot_target.prepare", title: "设置本用例待验收目标为 `submitted`，阶段为 `goalFrozen`，战利品提交时间已存在，挑战者账号身份仅包含普通成员", object: "db.review_loot_target", operator: "prepare", params: { objectiveIdFrom: "runtime.fixtureObjective.id", memberNameFrom: "data.memberName", saveAs: "reviewLootTarget" } },
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-4", method: "prisma" }, id: "db.review_loot_target.submitted", title: "本用例待验收目标 应为 `submitted`，阶段为 `goalFrozen`，战利品提交时间已存在，挑战者账号身份仅包含普通成员", object: "db.review_loot_target", operator: "submitted", params: { targetFrom: "runtime.reviewLootTarget", memberNameFrom: "data.memberName" } },
