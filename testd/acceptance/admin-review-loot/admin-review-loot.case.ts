...
export const adminReviewLootCase = {
  ...
  Setup: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Setup-11", method: "prisma" }, id: "db.review_loot_result.create", title: "创建本用例待验收目标的测试指标，标题为 `E2E-REVIEW-RESULT: 管理员验收战利品指标`，指标积分为 `42`", object: "db.review_loot_result", operator: "create", params: { targetFrom: "runtime.reviewLootTarget", titleFrom: "data.resultTitle", metricNameFrom: "data.metricName", pointsFrom: "data.points", saveAs: "reviewLootResult" } },
  ...
  S0: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S0-5", method: "prisma" }, id: "db.review_loot_result.present", title: "本用例待验收目标 应存在 指标积分为 `42` 的测试指标", object: "db.review_loot_result", operator: "present", params: { targetFrom: "runtime.reviewLootTarget", resultFrom: "runtime.reviewLootResult", pointsFrom: "data.points" } },
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-2", method: "prisma" }, id: "db.review_loot_target.settled", title: "本用例待验收目标的流转状态 应为 `settled`，验收结果 应为 `completed`，目标基础分数 应为 `42`，目标结算分数 应为 `42`", object: "db.review_loot_target", operator: "settled", params: { targetFrom: "runtime.reviewLootTarget", pointsFrom: "data.points" } },
      ...
      { source: { caseStepId: "S1-4", method: "prisma" }, id: "db.review_loot_ledger.present", title: "数据库中 应存在 普通成员对本用例待验收目标的测试积分流水，积分为 `42`，reason 为 `E2E-REVIEW-LOOT: 管理员验收战利品`", object: "db.review_loot_ledger", operator: "present", params: { targetFrom: "runtime.reviewLootTarget", memberNameFrom: "data.memberName", pointsFrom: "data.points", reasonFrom: "data.reason" } },
