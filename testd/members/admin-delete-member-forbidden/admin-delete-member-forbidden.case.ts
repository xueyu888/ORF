...
export const adminDeleteMemberForbiddenCase = {
  id: "members.admin-delete.member-forbidden",
  title: "管理员删除成员-普通成员不可删除成员",
  model: STATE_CASE_MODEL,
  tags: ["members", "delete", "member", "permission", "negative-path"],

  data: {
    memberEmail: "orf-member-delete-forbidden-e2e@orf.local",
    memberPassword: "OrfMemberDeleteForbiddenE2E!2026",
    memberName: "ORF Member Delete Forbidden E2E",
    memberRole: "member",
    targetUserId: "user-member-delete-forbidden-target-e2e",
    targetName: "ORF Member Delete Forbidden Target E2E",
    targetEmail: "orf-member-delete-forbidden-target-e2e@orf.local",
    targetRole: "member",
    targetStatus: "active",
  },
  ...
  Setup: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Setup-2", method: "api" }, id: "ory.member_identity.upsert", title: "准备普通成员认证身份，邮箱为 `orf-member-delete-forbidden-e2e@orf.local`，密码为固定测试密码", object: "ory.identity", operator: "upsert_password", params: { emailFrom: "data.memberEmail", nameFrom: "data.memberName", passwordFrom: "data.memberPassword", saveAs: "memberIdentity" } },
      { source: { caseStepId: "Setup-3", method: "prisma" }, id: "db.member.upsert", title: "准备普通成员用户和默认团队成员关系，邮箱为 `orf-member-delete-forbidden-e2e@orf.local`、角色为 `member`、状态为 `active`", object: "db.user", operator: "upsert", params: { emailFrom: "data.memberEmail", nameFrom: "data.memberName", roleFrom: "data.memberRole", status: "active", identityIdFrom: "runtime.memberIdentity.id", saveAs: "memberUser" } },
      { source: { caseStepId: "Setup-4", method: "prisma" }, id: "db.target.upsert", title: "准备被管理成员，邮箱为 `orf-member-delete-forbidden-target-e2e@orf.local`、角色为 `member`、状态为 `active`", object: "db.user", operator: "upsert", params: { userIdFrom: "data.targetUserId", emailFrom: "data.targetEmail", nameFrom: "data.targetName", roleFrom: "data.targetRole", statusFrom: "data.targetStatus", saveAs: "targetUser" } },
  ...
  S0: {
    description: "普通成员已登录，被管理成员和默认团队成员关系存在",
    assertions: [
      { source: { caseStepId: "S0-1", method: "api" }, id: "session.member.authenticated", title: "当前会话 应为 邮箱为 `orf-member-delete-forbidden-e2e@orf.local`、角色为 `member`、状态为 `active` 的已登录会话", object: "auth.session", operator: "authenticated", params: { emailFrom: "data.memberEmail", roleFrom: "data.memberRole", status: "active" } },
      ...
      { source: { caseStepId: "S0-3", method: "prisma" }, id: "db.target.email", title: "被管理成员 的邮箱 应为 \"orf-member-delete-forbidden-target-e2e@orf.local\"", object: "db.user", operator: "matches", params: { userIdFrom: "data.targetUserId", emailFrom: "data.targetEmail" } },
      { source: { caseStepId: "S0-4", method: "prisma" }, id: "db.target.role", title: "被管理成员 的角色 应为 member", object: "db.user", operator: "matches", params: { userIdFrom: "data.targetUserId", roleFrom: "data.targetRole" } },
      { source: { caseStepId: "S0-5", method: "prisma" }, id: "db.target.status", title: "被管理成员 的状态 应为 `active`", object: "db.user", operator: "matches", params: { userIdFrom: "data.targetUserId", statusFrom: "data.targetStatus" } },
      { source: { caseStepId: "S0-6", method: "prisma" }, id: "db.target.membership", title: "被管理成员 的默认团队成员关系 应存在，角色为 `member`", object: "db.default_team_membership", operator: "matches", params: { userIdFrom: "data.targetUserId", roleFrom: "data.targetRole" } },
    ],
  },
  ...
  S1: {
    description: "普通成员位于悬赏大厅，系统管理入口和成员删除入口不存在，被管理成员保持存在",
    assertions: [
      ...
      { source: { caseStepId: "S1-4", method: "playwright" }, id: "page.delete_action.absent", title: "成员删除入口 应不可见", object: "page.member_management", operator: "delete_action_absent" },
      { source: { caseStepId: "S1-5", method: "prisma" }, id: "db.target.email_unchanged", title: "被管理成员 的邮箱 应仍为 \"orf-member-delete-forbidden-target-e2e@orf.local\"", object: "db.user", operator: "matches", params: { userIdFrom: "data.targetUserId", emailFrom: "data.targetEmail" } },
      { source: { caseStepId: "S1-6", method: "prisma" }, id: "db.target.role_unchanged", title: "被管理成员 的角色 应仍为 member", object: "db.user", operator: "matches", params: { userIdFrom: "data.targetUserId", roleFrom: "data.targetRole" } },
      { source: { caseStepId: "S1-7", method: "prisma" }, id: "db.target.status_unchanged", title: "被管理成员 的状态 应仍为 `active`", object: "db.user", operator: "matches", params: { userIdFrom: "data.targetUserId", statusFrom: "data.targetStatus" } },
      { source: { caseStepId: "S1-8", method: "prisma" }, id: "db.target.membership_unchanged", title: "被管理成员 的默认团队成员关系 应仍存在，角色为 `member`", object: "db.default_team_membership", operator: "matches", params: { userIdFrom: "data.targetUserId", roleFrom: "data.targetRole" } },
      { source: { caseStepId: "S1-9", method: "api" }, id: "session.member.still_authenticated", title: "当前会话 应仍为 邮箱为 `orf-member-delete-forbidden-e2e@orf.local`、角色为 `member`、状态为 `active` 的已登录会话", object: "auth.session", operator: "authenticated", params: { emailFrom: "data.memberEmail", roleFrom: "data.memberRole", status: "active" } },
    ],
  },
  ...
  Clean: {
    ...
    steps: [
      ...
      { source: { caseStepId: "Clean-6", method: "api" }, id: "ory.member_identity.delete", title: "删除邮箱为 `orf-member-delete-forbidden-e2e@orf.local` 的普通成员认证身份", object: "ory.identity", operator: "delete_by_email", params: { emailFrom: "data.memberEmail" } },
      ...
      { source: { caseStepId: "Clean-8", method: "prisma" }, id: "db.member.delete", title: "删除邮箱为 `orf-member-delete-forbidden-e2e@orf.local` 的普通成员用户", object: "db.user", operator: "delete", params: { emailFrom: "data.memberEmail" } },
      ...
      { source: { caseStepId: "Clean-10", method: "api" }, id: "ory.member_identity.absent", title: "邮箱为 `orf-member-delete-forbidden-e2e@orf.local` 的普通成员认证身份 应不存在", object: "ory.identity", operator: "absent", params: { emailFrom: "data.memberEmail" } },
      { source: { caseStepId: "Clean-11", method: "prisma" }, id: "db.member.absent", title: "邮箱为 `orf-member-delete-forbidden-e2e@orf.local` 的普通成员用户 应不存在", object: "db.user", operator: "absent", params: { emailFrom: "data.memberEmail" } },
    ],
  },
