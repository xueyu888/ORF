...
export const memberTargetMutationForbiddenAllStagesCase = {
  ...
  S1: {
    ...
    assertions: [
      ...
      { source: { caseStepId: "S1-10", method: "playwright" }, id: "delete_confirm.absent", title: "删除目标确认框 应不可见", object: "page.objective_delete_confirm", operator: "absent", params: { resultFrom: "runtime.objectiveDeleteUiResult" } },
