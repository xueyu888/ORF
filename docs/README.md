...
| [ORF 挑战页面 - 前端.md](./frontend/ORF%20挑战页面%20-%20前端.md) | 挑战页内容区 UI、字段展示和可见交互 |
| [ORF 提交战利品页 - 前端.md](./frontend/ORF%20提交战利品页%20-%20前端.md) | 提交战利品子页面 UI 和提交交互 |
| [ORF 挑战交互组件 - 前端.md](./frontend/ORF%20挑战交互组件%20-%20前端.md) | 挑战页行操作、权限拦截、拖拽反馈和删除确认 |
| [ORF 悬赏流程 - 前端.md](./frontend/ORF%20悬赏流程%20-%20前端.md) | 悬赏大厅、悬赏指标流程阶段和操作入口 UI |
| [评论组件 - 前端.md](./frontend/评论组件%20-%20前端.md) | 评论浮窗 UI 和交互 |
| [ORF 任务管理页面 - 后端.md](./backend/ORF%20任务管理页面%20-%20后端.md) | 挑战页后端集合、悬赏指标关系、字段契约和交互业务约束 |
| [ORF 提交战利品 - 后端.md](./backend/ORF%20提交战利品%20-%20后端.md) | 提交战利品当前契约和后续接口 |
...
| [ORF 游戏化流程设计.md](./rules/ORF%20游戏化流程设计.md) | 悬赏指标流转的产品术语、核心原则和主支线流程 |
